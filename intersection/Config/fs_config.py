...
def config_fs(args, **kwargs):
    ...
    AV_FRAC = 0.10 # args.av_frac # For FS its 5%
    SCALING = 2
    ...
    # FS required desired velocity, but something like this is not defined for bottltneck.
    kwargs['classic_parms'] = {  'v_des': 5.0, # Add more if necessary
                                    }
