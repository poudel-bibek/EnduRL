...
def config_idm(args, **kwargs):
    ...
    V_ENTER = 5 if args.stability else 8 # Previously 30. This is m/s. 20 m/s = 44 mph, 72 km/hr
    ...
    # All IDM
    # But have to be added this way to make the flow_00 filters consistent
    vehicles.add(
    ...
    for edge in outer_edges:
        ...
        if edge == "left1_0" or edge == "right0_0":
            inflow.add(
                veh_type="human",
                edge=edge,
                vehs_per_hour= 0.75*EDGE_INFLOW, #All IDM
                departLane="free",
